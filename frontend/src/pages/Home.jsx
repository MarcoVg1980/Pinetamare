...
import { MapPin, Users, Bed, Bath, Wifi, Car, Wind, Home as HomeIcon, Mail, Phone, ChevronLeft, ChevronRight, Check, Facebook, MessageCircle, Star, Quote, X, Image, Calendar } from 'lucide-react';
            ...
            {galleryImages.map((image, index) => (
              ...
              >
                <img
                  src={image.url}
                  alt={image.title}
                  className={`w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 ${image.rotate ? 'rotate-90' : ''}`}
                  loading="lazy"
                />
